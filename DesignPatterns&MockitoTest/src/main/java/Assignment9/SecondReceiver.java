...
public class SecondReceiver extends Receivers implements Observer {
	...
	//	System.out.println(dateReturnedFromServer.getClass().getName());
	...
	public void message(Date dateReturnedFromServer) {
		...
		try {
	     ...
	     System.out.println("[2nd "+this.getClass().getName()+"]"+" Web page has been modified at :"+dateReturnedFromServer);	 
	else System.out.println("[2nd "+this.getClass().getName()+"]"+" Last time was modified at :"+dateReturnedFromServer);
		}
		catch(Exception exception) {

			System.out.println("[2nd "+this.getClass().getName()+"]"+"waiting...");
		}
	}

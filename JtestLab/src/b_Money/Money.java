...
public class Money implements Comparable {
	...
	public String getAmountInInteger() {
	...
	int universalVal = getCurrency().universalValue(this.getAmount());
		return universalVal;
	}
	...
	public Money add(Money other) {
		int sum =this.getAmount()+other.currency.valueInThisCurrency(other.getAmount(), this.getCurrency());
	...
	public Money sub(Money other) {
		int sum =this.getAmount()-other.getCurrency().valueInThisCurrency(other.getAmount(), other.getCurrency());
		return new Money(sum,this.getCurrency());
	}
	...
	public int compareTo(Object other) {
		Money money2 = (Money) other;
		int thisVal = this.universalValue();
		int outer = money2.universalValue();
		
		if(thisVal < outer) return -1;
		if(thisVal > outer) return 1;
		return 0;
	}
